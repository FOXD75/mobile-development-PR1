...
2. В имени приложения, путём изменения содержимого файла "strings.xml", было указано авторство. На странице приложения указана дата рождения с помощью свойства страницы TextView.
...
```
![Рисунок 3. - Результат работы кода](images/image_3.png)
...
```
![Рисунок 4. - Результат работы кода](image_4.png)
